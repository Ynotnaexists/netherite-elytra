...
public class ModItems {
    ...
    public static final Item NETHERITE_ELYTRA = registerItem("netherite_elytra", new NetheriteElytraItem(new Item.Settings().maxDamage(472).rarity(Rarity.EPIC).fireproof()));
